...
namespace XBOXGameBarPoC_UWP
{
    ...
    sealed partial class App : Application
    {
        ...
        public App()
        {
            var sid = WebAuthenticationBroker.GetCurrentApplicationCallbackUri().Host;
            ApplicationData.Current.LocalSettings.Values["AppSID"] = sid.ToUpper();
